  ...
  const  articles= [
    ...
    return (
        ...
        <div style={{display:"flex"}}>
           <input type="text"  placeholder='Search for other Student.....'/>
           <input type="text" placeholder='Search for Faculity.........'/>
           </div>
           ...
           <div>
           <h1 style={{margin:"10%"}}>Student</h1>
           <h1 style={{margin:"10%"}}>37</h1>
           </div>
           </div>
           ...
           <div>
           <h1 style={{margin:"10%"}}>Faculity</h1>
           <h1 style={{margin:"10%"}}>1</h1>
           </div>
           </div>
           ...
           <div>
           <h1 style={{margin:"10%"}}>Courses</h1>
           <h1 style={{margin:"10%"}}>103</h1>
           </div>
           </div>
           </div>
